...
const MobileHeader = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-10 flex items-center justify-between h-14 px-4 bg-white dark:bg-black border-b border-gray-200 dark:border-gray-800 md:hidden">
