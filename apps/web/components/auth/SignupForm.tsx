      ...
      <form className="space-y-6">
        ...
        {isVerificationSent && (
          <div>
            ...
            {verificationMessage && (
              <p className="text-red-500 text-xs mt-1 pl-10">{verificationMessage}</p>
            )}
          </div>
        )}
        ...
        {errors?.passwordConfirm && (
          <p className="text-red-500 text-xs mt-1 pl-10">{errors.passwordConfirm}</p>
        )}
        <div className="flex items-center space-x-4">
        ...
        <div className="pt-6 space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => handleLabelClick('terms')}
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => handleLabelClick('privacy')}
              className="text-sm text-blue-500 hover:underline cursor-pointer"
            >
              보기
            </button>
