...
제1조(목적)
PikUme(이하 ‘회사’라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스')를 이용하는 개인(이하 '이용자' 또는 '개인')의 정보(이하 '개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 '본 방침')을 수립합니다.
...
회사는 이용자의 서비스 이용에 따른 통계•분석 및 부정이용의 확인 • 분석을 위하여 다음과 같은 정보를 수집합니다. (부정이용이란 회원탈퇴 후 재가입, 상품구매 후 구매취소 등을 반복적으로 행하는 등 회사가 제공하는 경제상 이익을 불•편법적으로 수취하는 행위, 이용약관 등에서 금지하고 있는 행위, 명의도용 등의 불•편법행위 등을 말합니다.)
	1. 필수 수집 정보: 서비스 이용기록, 쿠키 및 기기정보, IP 주소, 접속 로그
	2. 수집 목적: 
		가. 서비스 이용 통계 및 장기 트렌드 분석
		나. 부정 이용 방지 및 보안 강화
		다. 서비스 개선 및 맞춤형 서비스 제공
		라. 중복 접속 방지 및 접속자 수 집계
		마. 서비스 운영 정책 수립 및 비즈니스 인사이트 도출

제9조(개인정보 수집 방법)
회사는 다음과 같은 방법으로 이용자의 개인정보를 수집합니다.
	1. 이용자가 회사의 홈페이지에 자신의 개인정보를 입력하는 방식
	2. 어플리케이션 등 회사가 제공하는 홈페이지 외의 서비스를 통해 이용자가 자신의 개인 정보를 입력하는 방식
	3. 서비스 이용 과정에서 자동으로 생성•수집되는 정보 (IP 주소, 쿠키, 방문 기록 등)
...
회사는 개인정보를 다음 각 호의 경우에 이용합니다.
	...
	5. 서비스 이용 통계 작성, 접속 빈도 분석, 장기 트렌드 분석, 서비스 개선 및 맞춤형 서비스 제공을 위한 경우
	6. 보안, 프라이버시 및 안전 문제와 관련하여 서비스를 보호하기 위한 경우
	7. 서비스 운영 정책 수립, 비즈니스 전략 개발 및 데이터 기반 의사결정을 위한 경우
...
제11조(개인정보의 보유 및 이용기간)
	...
	3. IP 주소 및 접속 로그는 서비스 이용 통계 및 보안 목적으로 수집일로부터 최대 3개월간 보관하며, 해당 기간 경과 후 지체 없이 파기합니다.
...
회사는 관계법령에 따라 다음과 같이 개인정보를 보유 및 이용합니다.
	...
	2. 통신비밀보호법에 따른 보유정보 및 보유기간 
		가. 웹사이트 로그 기록 자료(IP 주소, 접속시간, 이용기록 등) : 3개월
...
제17조(이용자의 의무)
	...
	2. 타인의 개인정보를 도용한 회원가입의 경우 이용자 자격을 상실하거나 관련 개인정보 보호 법령에 의해 처벌받을 수 있습니다.
...
제22조(권익침해에 대한 구제방법)
	1. 정보주체는 개인정보침해로 인한 구제를 받기 위하여 개인정보분쟁조정위원회, 한국 인터넷진흥원 개인정보침해신고센터 등에 분쟁해결이나 상담 등을 신청할 수 있습니다. 이 밖에 기타 개인정보침해의 신고, 상담에 대하여는 아래의 기관에 문의하시기 바랍니다.
