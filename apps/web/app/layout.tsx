...
const BASE_URL = (process.env.NEXT_PUBLIC_BASE_URL || 'https://www.pikume.com').replace(/\/+$/, '');
...
export const metadata: Metadata = {
  ...
  description:
    'PIKU 캐릭터로 기록하는 감정 다이어리. 캐릭터와 함께 하루 한 장 일기를 작성하고 친구들과 감정을 공유해보세요.',
  keywords: [
    '감정 다이어리',
    '캐릭터 일기',
    'PIKU',
  ...
  icons: {
    ...
    apple: [{ url: `${BASE_URL}/apple-touch-icon.png`, sizes: '180x180', type: 'image/png' }],
  },
