...
제13조(서비스의 제공)
	...
	3. 회사가 제공하는 서비스의 내용은 다음과 같습니다.
		...
		나. 나만의 캐릭터 설정 및 사용자 맞춤형 콘텐츠 제공, 달력 레이아웃 및 이미지 시각화 최적화, 친구 관 계 기반 일기 추천 및 피드 구성, 회원의 활동에 기반한 공지, 알림, 서비스 안내 제공
	4. 다. AI 기반 일기 내용 분석 및 캐릭터 이미지 자동 생성 서비스, 외부 이미지 업로드 기능 및 이미지 관리
	5. 도구, 서비스 고도화를 위한 기능 업데이트 또는 외부 연동 서비스 제공 라. 일기 비공개/친구공개/전체공개 설정 기능, 대표 일기 자동 설정 및 달력 내 노출 기능, 친구의 달력
	6. 열람 및 피드 탐색 기능, 사용자 신고 및 차단 기능,
